...
-- -----------------------------------------------------
-- Table `pro_buddy`.`user_chat`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pro_buddy`.`user_chat` ;

CREATE TABLE IF NOT EXISTS `pro_buddy`.`user_chat` (
  `message_id` INT NOT NULL,
  `message` VARCHAR(500) NULL,
  `from_auth_user_id` INT NULL,
  `to_auth_user_id` INT NULL,
  `create_time` DATETIME NULL,
  `update_time` DATETIME NULL,
  `is_received` TINYINT NULL,
  `is_modified` TINYINT NULL,
  `is_read` TINYINT NULL,
  PRIMARY KEY (`message_id`),
  INDEX `fk_from_auth_user_idx` (`from_auth_user_id` ASC) VISIBLE,
  INDEX `fk_to_auth_user_idx` (`to_auth_user_id` ASC) VISIBLE,
  CONSTRAINT `fk_from_auth_user`
    FOREIGN KEY (`from_auth_user_id`)
    REFERENCES `pro_buddy`.`auth_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_to_auth_user`
    FOREIGN KEY (`to_auth_user_id`)
    REFERENCES `pro_buddy`.`auth_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pro_buddy`.`auth_user_ext`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pro_buddy`.`auth_user_ext` ;

CREATE TABLE IF NOT EXISTS `pro_buddy`.`auth_user_ext` (
  `auth_user_id` INT NOT NULL,
  `gender` VARCHAR(25) NULL,
  `DoB` DATE NULL,
  `address` VARCHAR(200) NULL,
  PRIMARY KEY (`auth_user_id`),
  CONSTRAINT `fk_auth_user_ext`
    FOREIGN KEY (`auth_user_id`)
    REFERENCES `pro_buddy`.`auth_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
